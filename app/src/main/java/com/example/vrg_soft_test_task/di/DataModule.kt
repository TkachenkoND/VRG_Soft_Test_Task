...
import com.example.vrg_soft_test_task.data.repository_impl.SaveImageInStorageRepositoryImpl
...
val dataModule = module {
    ...
    single<SaveImageInStorageRepository> { SaveImageInStorageRepositoryImpl(get()) }
}